...
urlpatterns = [
    ...
    path('dash_adm/',views.dash_doc_view,name='dashboard_adm.html'),
    path('bookapp_adm/',views.bookapp_doc_view,name='bookapp_adm.html'),
    path('calladoc_adm/',views.calladoc_doc_view,name='calladoc_adm.html'),
    path('feedback_adm/',views.feedback_doc_view,name='feedback_adm.html'),
    path('medicalreport_adm/',views.medicalreport_doc_view,name='medicalreport_adm.html'),
    path('profile_adm/',views.profile_doc_view,name='profile_adm.html'),
    path('yourhealth_adm/',views.yourhealth_doc_view,name='yourhealth_adm.html'),
    path('home/',views.home_view,name='home.html'),
