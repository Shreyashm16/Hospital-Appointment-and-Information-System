...
urlpatterns = [
    ...
    path('admit_details_doc/<int:pk>/<str:commodity>/<int:price>/<int:quantity>',views.admit_details_particular_doc_add_charge_view,name='admit_details_particular_doc_add_charge'),
