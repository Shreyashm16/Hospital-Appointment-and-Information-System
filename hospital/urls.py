...
urlpatterns = [
    ...
    path('admit_details_doc/<int:pk>/<str:comm>/<str:price>/<int:quan>',views.admit_details_particular_doc_add_charge_view,name='admit_details_particular_doc_add_charge'),
    ...
    path('bookapp_doc/<int:pk>',views.appointment_details_particular_doc_view,name='bookapp_details_prticular_doc.html'),
